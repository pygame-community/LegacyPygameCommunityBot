...
async def on_ready():
    ...
    """
    await pgbot.init()
    await job_manager.dispatch_event(events.OnReady())
...
async def on_member_remove(member: discord.Member):
    ...
    await job_manager.dispatch_event(events.OnMemberRemove(member))


@bot.event
async def on_member_update(before: discord.Member, after: discord.Member):
    await job_manager.dispatch_event(events.OnMemberUpdate(before, after))
...
async def on_member_ban(
    ...
    await job_manager.dispatch_event(events.OnMemberBan(guild, user))


@bot.event
async def on_member_unban(guild: discord.Guild, user: discord.User):
    await job_manager.dispatch_event(events.OnMemberUnban(guild, user))
...
async def on_message_delete(message: discord.Message):
    ...
    await job_manager.dispatch_event(events.OnMessageDelete(message))
...
async def on_reaction_add(
    ...
    await job_manager.dispatch_event(events.OnReactionAdd(reaction, user))
...
async def on_raw_reaction_add(payload: discord.RawReactionActionEvent):
    ...
    await job_manager.dispatch_event(events.OnRawReactionAdd(payload))
...
async def on_reaction_remove(
    ...
    await job_manager.dispatch_event(events.OnReactionRemove(reaction, user))
...
async def on_raw_reaction_remove(payload: discord.RawReactionActionEvent):
    ...
    await pgbot.raw_reaction_add(payload)
    await job_manager.dispatch_event(events.OnRawReactionRemove(payload))
...
async def on_reaction_clear(
    ...
    await job_manager.dispatch_event(events.OnReactionClear(message, reactions))


@bot.event
async def on_raw_reaction_clear(payload: discord.RawReactionClearEvent):
    await job_manager.dispatch_event(events.OnRawReactionClear(payload))


@bot.event
async def on_reaction_clear_emoji(reaction: discord.Reaction):
    await job_manager.dispatch_event(events.OnReactionClearEmoji(reaction))


@bot.event
async def on_raw_reaction_clear_emoji(payload: discord.RawReactionClearEmojiEvent):
    await job_manager.dispatch_event(events.OnRawReactionClearEmoji(payload))


@bot.event
async def on_private_channel_create(channel: discord.abc.PrivateChannel):
    await job_manager.dispatch_event(events.OnPrivateChannelCreate(channel))


@bot.event
async def on_private_channel_delete(channel: discord.abc.PrivateChannel):
    await job_manager.dispatch_event(events.OnPrivateChannelDelete(channel))
...
async def on_guild_channel_create(channel: discord.abc.GuildChannel):
    await job_manager.dispatch_event(events.OnGuildChannelCreate(channel))


@bot.event
async def on_guild_channel_delete(channel: discord.abc.GuildChannel):
    await job_manager.dispatch_event(events.OnGuildChannelDelete(channel))
...
async def on_guild_channel_update(
    ...
    await job_manager.dispatch_event(events.OnGuildChannelUpdate(before, after))
...
async def on_guild_integrations_update(guild: discord.Guild):
    await job_manager.dispatch_event(events.OnGuildIntegrationsUpdate(guild))


@bot.event
async def on_webhooks_update(channel: discord.abc.GuildChannel):
    await job_manager.dispatch_event(events.OnWebhooksUpdate(channel))


@bot.event
async def on_user_update(before: discord.User, after: discord.User):
    await job_manager.dispatch_event(events.OnUserUpdate(before, after))


@bot.event
async def on_guild_join(guild: discord.Guild):
    await job_manager.dispatch_event(events.OnGuildJoin(guild))


@bot.event
async def on_guild_remove(guild: discord.Guild):
    await job_manager.dispatch_event(events.OnGuildRemove(guild))


@bot.event
async def on_guild_update(before: discord.Guild, after: discord.Guild):
    await job_manager.dispatch_event(events.OnGuildUpdate(before, after))


@bot.event
async def on_guild_role_create(role: discord.Role):
    await job_manager.dispatch_event(events.OnGuildRoleCreate(role))


@bot.event
async def on_guild_role_delete(role: discord.Role):
    await job_manager.dispatch_event(events.OnGuildRoleDelete(role))


@bot.event
async def on_guild_role_update(before: discord.Role, after: discord.Role):
    await job_manager.dispatch_event(events.OnGuildRoleUpdate(before, after))
...
async def on_guild_available(guild: discord.Guild):
    ...
    await job_manager.dispatch_event(events.OnGuildAvailable(guild))


@bot.event
async def on_guild_unavailable(guild: discord.Guild):
    await job_manager.dispatch_event(events.OnGuildUnavailable(guild))
...
async def on_invite_create(invite: discord.Invite):
    await job_manager.dispatch_event(events.OnInviteCreate(invite))


@bot.event
async def on_invite_delete(invite: discord.Invite):
    await job_manager.dispatch_event(events.OnInviteDelete(invite))


@bot.event
async def on_group_join(channel: discord.GroupChannel, user: discord.User):
    await job_manager.dispatch_event(events.OnGroupJoin(channel, user))


@bot.event
async def on_group_remove(channel: discord.GroupChannel, user: discord.User):
    await job_manager.dispatch_event(events.OnGroupRemove(channel, user))


@bot.event
async def on_relationship_add(relationship: discord.Relationship):
    await job_manager.dispatch_event(events.OnRelationshipAdd(relationship))


@bot.event
async def on_relationship_remove(relationship: discord.Relationship):
    await job_manager.dispatch_event(events.OnRelationshipRemove(relationship))
...
async def on_relationship_update(
    ...
    await job_manager.dispatch_event(events.OnRelationshipUpdate(before, after))
