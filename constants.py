...
ADMIN_ROLES = {772521884373614603, 772508687256125440, 772849669591400501, 757845292526731274, 757845497795838004, 783219011294724137}
...
ADMIN_USERS = {414330602930700288, 265154376409153537, 444116866944991236, 590160104871952387, 763015391710281729}

# PGC pygame beginner, PGC pygame regular, PGC pygame pro, PGC pygame contributor
COMPETENCE_ROLES = {772536799926157312, 772536976262823947, 772537033078997002, 772537232594698271}
